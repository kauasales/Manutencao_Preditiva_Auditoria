...
//MINHA CASA
const char* ssid = "Kauã's Galaxy S20 FE";
const char* password = "KAUAKAUA";

//const char* mqtt_server = "10.20.50.158"; //PC CALLIDUS
const char* mqtt_server = "192.168.212.61"; //MEU PC
